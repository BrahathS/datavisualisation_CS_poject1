  ...
  this.draw = function() {
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      var company = {
        ...
        'name': this.data.getString(i, 'company'),  //get data to string from excel 
        'female': this.data.getNum(i, 'female'),   //get data to number from excel
        'male': this.data.getNum(i, 'male'),      //get data to number from excel
